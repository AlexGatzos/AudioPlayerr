...
public class MusicDatabase {
  ...
  public void init() {
    ...
    String query = str
      .append("CREATE TABLE \"public\".\"Song\" (")
      .append("\"id\" text   NOT NULL ,")
      .append("")
      .append("\"title\" text   NOT NULL ,")
      .append("\"genre\" text   ,")
      .append("\"cd_track_number\" text   ,")
      .append("\"duration\" integer   NOT NULL ,")
      .append("\"year\" text   ,")
      .append("\"path\" text   NOT NULL ,")
      .append("\"albumId\" text   ,")
      .append("\"artistId\" text   ,")
      .append("PRIMARY KEY (\"id\")")
      .append(")")
      .append("")
      .append("CREATE TABLE \"public\".\"Album\" (")
      .append("\"id\" text   NOT NULL ,")
      .append("\"title\" text   NOT NULL ,")
      .append("\"genre\" text   ,")
      .append("\"year\" text   ,")
      ...
      .append(")")
      .append("")
      .append("CREATE TABLE \"public\".\"Artist\" (")
      .append("\"id\" text   NOT NULL ,")
      .append("\"title\" text   NOT NULL ,")
      .append("PRIMARY KEY (\"id\")")
      .append(")")
      .append("")
      .append("CREATE TABLE \"public\".\"Playlist\" (")
      .append("\"id\" text   NOT NULL ,")
      .append("\"title\" text   NOT NULL ,")
      .append("PRIMARY KEY (\"id\")")
      .append(")")
      .append("")
      .append("CREATE TABLE \"public\".\"_PlaylistToSong\" (")
      .append("\"A\" text   NOT NULL ,")
      .append("\"B\" text   NOT NULL ")
      .append(")")
      .append("")
      .append("CREATE UNIQUE INDEX \"Song.path_unique\" ON \"public\".\"Song\"(\"path\")")
      .append("")
      .append("CREATE UNIQUE INDEX \"Album.artistId_title_unique\" ON \"public\".\"Album\"(\"artistId\", \"title\")")
      .append("")
      .append("CREATE UNIQUE INDEX \"Artist.title_unique\" ON \"public\".\"Artist\"(\"title\")")
      .append("")
      .append("CREATE UNIQUE INDEX \"_PlaylistToSong_AB_unique\" ON \"public\".\"_PlaylistToSong\"(\"A\", \"B\")")
      .append("")
      .append("CREATE INDEX \"_PlaylistToSong_B_index\" ON \"public\".\"_PlaylistToSong\"(\"B\")")
      .append("")
      .append("ALTER TABLE \"public\".\"Song\" ADD FOREIGN KEY (\"albumId\")REFERENCES \"public\".\"Album\"(\"id\") ON DELETE SET NULL ON UPDATE CASCADE")
      .append("")
      .append("ALTER TABLE \"public\".\"Song\" ADD FOREIGN KEY (\"artistId\")REFERENCES \"public\".\"Artist\"(\"id\") ON DELETE SET NULL ON UPDATE CASCADE")
      .append("")
      .append("ALTER TABLE \"public\".\"Album\" ADD FOREIGN KEY (\"artistId\")REFERENCES \"public\".\"Artist\"(\"id\") ON DELETE SET NULL ON UPDATE CASCADE")
      .append("")
      .append("ALTER TABLE \"public\".\"_PlaylistToSong\" ADD FOREIGN KEY (\"A\")REFERENCES \"public\".\"Playlist\"(\"id\") ON DELETE CASCADE ON UPDATE CASCADE")
      .append("")
      .append("ALTER TABLE \"public\".\"_PlaylistToSong\" ADD FOREIGN KEY (\"B\")REFERENCES \"public\".\"Song\"(\"id\") ON DELETE CASCADE ON UPDATE CASCADE")
      .toString();
